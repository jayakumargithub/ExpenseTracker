...
namespace ExpenseTracker.Repository
{
    public class ExpenseTrackerEFRepository : IExpenseTrackerRepository
    {
        ...
        private ExpenseTrackerContext _ctx;//{ get; set; }
       ...
       // public ExpenseTrackerEFRepository()
        ...
        public RepositoryActionResult<ExpenseGroup> DeleteExpenseGroup(int id)
        {
            try
            {
                ...
                var eg = _ctx.ExpenseGroups.FirstOrDefault(e => e.Id == id);
                if (eg != null)
                {
                    // also remove all expenses linked to this expensegroup
                    //var exp = _ctx.Expenses.FirstOrDefault(x => x.ExpenseGroupId == id);
                    //if (exp != null)
                    //{
                    //    _ctx.Expenses.Remove(exp);
                    //}
