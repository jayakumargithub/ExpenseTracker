    ...
    public class ExpenseGroupsController : Controller
    {
        ...
        public async Task<ActionResult> Index(int? page = 1)
        {
            ...
            if (egsResponse.IsSuccessStatusCode)
            {
                ...
                var lstExpenseGroupStatusses = JsonConvert.DeserializeObject<IEnumerable<Dto.ExpenseGroupStatus>>(egsContent);
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var lstExpenseGroups = JsonConvert.DeserializeObject<IEnumerable<Dto.ExpenseGroup>>(content);

                var pagedExpenseGroupsList = new StaticPagedList<Dto.ExpenseGroup>(lstExpenseGroups, pagingInfo.CurrentPage, 
